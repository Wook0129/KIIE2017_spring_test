...
class DataHandler:
    ...
    def __init__(self, data):
        ...
        for var_idx, var_name in enumerate(self.var_names):
            ...
            bins_related_with_var = [bin_name for bin_name in self.bin_names if
                                     var_name in bin_name]
            self.proportion_of_bins_by_var[var_idx] = list(
                self.onehot_encoded_data[bins_related_with_var].mean(axis=0))
